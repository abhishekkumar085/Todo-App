...
export default function Home() {
  ...
  return (
    <div className="flex h-screen flex-grow items-start justify-center bg-gray-100 p-4">
      <div className="task-app w-full max-w-md rounded-lg bg-[#FFFFFF] px-6 pb-2 pt-6 text-gray-200 shadow-lg">
